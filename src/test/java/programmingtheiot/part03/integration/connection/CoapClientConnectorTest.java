...
public class CoapClientConnectorTest
{
	...
	public void testPostRequestCon()
	{
		...
		assertTrue(this.coapClient.sendPostRequest(ResourceNameEnum.GDA_MGMT_STATUS_MSG_RESOURCE, ssdJson, true, ssdJson, DEFAULT_TIMEOUT));
	}
	/**
	 * 
	 */
	...
	public void testPostRequestNon()
	{
		...
		ssd.setCommand(actionCmd);
		String ssdJson = DataUtil.getInstance().systemStateDataToJson(ssd);
		assertTrue(this.coapClient.sendPostRequest(ResourceNameEnum.GDA_MGMT_STATUS_MSG_RESOURCE, ssdJson, false, ssdJson, DEFAULT_TIMEOUT));
